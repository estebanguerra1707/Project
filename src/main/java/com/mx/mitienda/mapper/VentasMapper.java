...
public class VentasMapper {
    ...
    public Venta toEntity(VentaRequestDTO ventasRequestDTO, String username) {
        ...
        Sucursal sucursal = sucursalRepository.findByIdAndActiveTrue(ventasRequestDTO.getBranchId())
        ...
        BigDecimal amountPaid = paymentMethod.getName().equalsIgnoreCase(EFECTIVO.name().toLowerCase())
